      ...
      >
        ...
        <div className="flex gap-12 items-center text-sm  max-lg:hidden">
          {navLinks.map((item) => {
            return (
              <div
                className="flex gap-2 cursor-pointer font-medium group"
                key={item.name}
              >
                {item.name === "About DiAtom" ? (
                  ...
                  >
                    <p className=" transition-all  duration-150 delay-100 group-hover:text-teal-600">
                      {item.name}
                    </p>
                    <svg
                      xmlns="http://www.w4.org/2000/svg"
                      className="transition-all  relative top-[1px] duration-150 delay-150 group-hover:fill-teal-500"
                      height="24px"
                  ...
                  <Link
                    href={item.href}
                    className={cn(
                      "transition-all  duration-150 delay-100 hover:text-teal-600",
                      pathname === item.href
                        ? "text-teal-600 fill-teal-500"
                        : "text-black",
                    )}
