...
export default function Accordian() {
  ...
  return (
    <div className={cn("padding-x pt-24 w-full open-sans")} id="business">
      ...
      <div className="w-full pt-24 pb-12 flex gap-8">
        <div className="w-1/2 flex items-start justify-start z-10 max-lg:hidden ">
          {showImage.image1 && <Lottie animationData={instrument} loop={true} className="mt-10 max-w-xl" rendererSettings={{ preserveAspectRatio: "xMidYMid slice" }} />}
          ...
          {showImage.image3 && <Lottie animationData={record} loop={true} className=" mt-6 max-w-[27rem] w-full" rendererSettings={{ preserveAspectRatio: "xMidYMid slice" }} />}
        </div>
